...
def create_tracker(tracker_type, tracker_config, reid_weights, device, half):
    ...
    if tracker_type == 'strongsort':
        ...
        from ocsort.ocsort import OCSort  # Remove 'trackers.'
        ...
        from bytetrack.byte_tracker import BYTETracker  # Remove 'trackers.'
        ...
        from botsort.bot_sort import BoTSORT  # Remove 'trackers.'
